...
function addSection(section, mapUrl, mappings, sources, sourcesContent, names, stopLine, stopColumn) {
    ...
    for (let i = 0; i < len; i++) {
        ...
        for (let j = 0; j < line.length; j++) {
            ...
            // to stop early.
            if (i === stopLine && column >= stopColumn)
                break;
            if (seg.length === 1) {
                out.push([column]);
                continue;
...
export { AnyMap, GREATEST_LOWER_BOUND, LEAST_UPPER_BOUND, TraceMap, decodedMappings, eachMapping, encodedMappings, generatedPositionFor, originalPositionFor, presortedDecodedMap, traceSegment };
